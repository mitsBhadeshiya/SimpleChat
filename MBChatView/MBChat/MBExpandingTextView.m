...
@implementation MBExpandingTextView
...
#endif
{
    ...
    r.origin.x = 0;
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    internalTextView = [[MBTextView alloc] initWithFrame:r textContainer:textContainer];
#else
                    ...
                    [UIView animateWithDuration:animationDuration
                                     ...
                                     completion:^(BOOL finished) {
                                         if ([delegate respondsToSelector:@selector(expandingTextView:didChangeHeight:)]) {
                                             [delegate expandingTextView:self didChangeHeight:newSizeH];
                                         }
                                     }];
#endif
                } else {
...
-(void)resizeTextView:(NSInteger)newSizeH
{
    if ([delegate respondsToSelector:@selector(expandingTextView:willChangeHeight:)]) {
        [delegate expandingTextView:self willChangeHeight:newSizeH];
    }
